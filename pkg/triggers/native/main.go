...
func (*NativeTriggerBuilderConfig[Request, Response]) Deploy(ctx *resources.ResourceFactoryContext, db resources.DeploymentBuilder) (triggers.Trigger[Request, Response], error) {
